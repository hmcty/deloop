...
#define WM8960_REG_MASK_LEFT_CHAN_VOL_LDACVOL (uint8_t) (0x7F)      // 0=MUTE, 0x7F=0dB

#define WM8960_REG_MASK_RIGHT_CHAN_VOL_DACVU   (uint8_t) (0x01 << 8) // 0=OFF, 1=ON
#define WM8960_REG_MASK_RIGHT_CHAN_VOL_RDACVOL (uint8_t) (0x7F)      // 0=MUTE, 0x7F=0dB

#define WM8960_REG_MASK_LEFT_MIXER_CTL_LD2LO  (uint8_t) (0x01 << 8) // 0=OFF, 1=ON
#define WM8960_REG_MASK_RIGHT_MIXER_CTL_RD2RO (uint8_t) (0x01 << 8) // 0=OFF, 1=ON

#define WM8960_REG_MASK_CLASS_D_CTL_1_SPK_OP_EN (uint8_t) (0x02 << 6) // 0x00=OFF, 0x01=L, 0x10=R, 0x11=L+R
