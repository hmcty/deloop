...
private:
  ...
  static constexpr uint16_t kNumBytesPerPixel = 3;
  static constexpr uint16_t kResetPadSize = 50;
  static constexpr uint16_t kBufferSize =
      NUM_PIXELS * kNumBytesPerPixel * 8 + kResetPadSize;
